...
class NewAlvallalkozoModal extends Component {
    ...
    submitBtnClick(){
        ...
        API.post('alvallalkozo/create', 'cegnev='+cegnev+'&email='+email+'&vezeteknev='+vezeteknev+'&keresztnev='+keresztnev+'&telefon='+encodeURIComponent(telefon)+'&megjegyzes='+encodeURIComponent(megjegyzes)+'&megnevezes='+encodeURIComponent(megnevezes)+'&bankszamlaszam='+bankszamlaszam+'&adoszam='+adoszam+'&API_SECRET='+API_SECRET)
            .then(res => {
